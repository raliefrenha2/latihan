...
<div class="panel panel-primary">
    <div class="panel-heading">
      <h3 class="panel-title">Users
          ...
          <a href="{{ route('user.export') }}" class="btn btn-warning pull-right" style="margin-top: -8px; margin-right: 5px;" title="Export/import Excel"><i class="icon-table"></i> Export</a>
      </h3>
    </div>
